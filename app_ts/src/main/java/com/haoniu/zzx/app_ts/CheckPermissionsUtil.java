...
/**
 * 作者： liuyuanbo on 2018/11/10 00:21.
 * 时间： 2018/11/10 00:21
 * 邮箱： 972383753@qq.com
 * 用途：
 */
public class CheckPermissionsUtil {
    ...
    private static final String TAG = CheckPermissionsUtil.class.getSimpleName();
    ...
    public static String[] getNeededPermission(Context context, String[] permissionArray) {
        ...
        for (int i = 0; i < permissionArray.length; i++) {
            if (CheckPermissionsUtil.isNeedAddPermission(context, permissionArray[i])) {
