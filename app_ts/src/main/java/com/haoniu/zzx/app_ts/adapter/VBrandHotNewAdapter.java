...
/**
 * Created by zzx on 2018/07/07/上午 10:03
 */

public class VBrandHotNewAdapter extends BaseQuickAdapter<HomeNewDataInfo.HotBean.GoodsBean,BaseViewHolder> {
    public VBrandHotNewAdapter(List<HomeNewDataInfo.HotBean.GoodsBean> data) {
        super(R.layout.adapter_brand, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, HomeNewDataInfo.HotBean.GoodsBean model) {
